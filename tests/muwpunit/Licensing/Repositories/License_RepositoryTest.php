...
final class License_RepositoryTest extends HarborTestCase {
	...
	protected function setUp(): void {
		...
		delete_network_option( null, License_Repository::KEY_OPTION_NAME );
	...
	public function test_get_prefers_network_key_over_site_key(): void {
		update_option( License_Repository::KEY_OPTION_NAME, 'SITE-KEY' );
		update_network_option( null, License_Repository::KEY_OPTION_NAME, 'NETWORK-KEY' );

		$this->assertSame( 'NETWORK-KEY', $this->repository->get_key() );
	}

	public function test_get_falls_back_to_site_key_when_no_network_key(): void {
		update_option( License_Repository::KEY_OPTION_NAME, 'SITE-KEY' );

		$this->assertSame( 'SITE-KEY', $this->repository->get_key() );
	}
	...
	public function test_store_with_network_true_writes_to_network_option(): void {
		$this->repository->store_key( 'NETWORK-KEY', true );

		$this->assertSame( 'NETWORK-KEY', get_network_option( null, License_Repository::KEY_OPTION_NAME ) );
	...
	public function test_store_with_network_false_writes_to_site_option(): void {
		$this->repository->store_key( 'SITE-KEY', false );

		$this->assertSame( 'SITE-KEY', get_option( License_Repository::KEY_OPTION_NAME ) );
		$this->assertEmpty( get_network_option( null, License_Repository::KEY_OPTION_NAME ) );
	}

	public function test_store_network_is_idempotent_when_key_unchanged(): void {
		$this->repository->store_key( 'NETWORK-KEY', true );

		$this->assertTrue( $this->repository->store_key( 'NETWORK-KEY', true ) );
	}

	public function test_delete_with_network_true_removes_network_option(): void {
		update_network_option( null, License_Repository::KEY_OPTION_NAME, 'NETWORK-KEY' );

		$this->repository->delete_key( true );
	...
	public function test_delete_with_network_false_does_not_affect_network_option(): void {
		...
		$this->repository->delete_key( false );
