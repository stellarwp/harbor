...
final class Feature_ControllerTest extends HarborTestCase {
	...
	public function test_get_single_feature_returns_all_fields(): void {
		...
		$request  = new WP_REST_Request( 'GET', '/liquidweb/harbor/v1/features/feature-alpha' );
		$response = $this->server->dispatch( $request );
	...
	public function test_get_unknown_slug_returns_404(): void {
		...
		$request  = new WP_REST_Request( 'GET', '/liquidweb/harbor/v1/features/nonexistent' );
		$response = $this->server->dispatch( $request );
	...
	public function test_enable_returns_success_for_admin(): void {
		...
		$request  = new WP_REST_Request( 'POST', '/liquidweb/harbor/v1/features/feature-alpha/enable' );
		$response = $this->server->dispatch( $request );
	...
	public function test_enable_invalid_slug_returns_error(): void {
		...
		$request  = new WP_REST_Request( 'POST', '/liquidweb/harbor/v1/features/nonexistent/enable' );
		$response = $this->server->dispatch( $request );
	...
	public function test_disable_returns_success_for_admin(): void {
		...
		$request  = new WP_REST_Request( 'POST', '/liquidweb/harbor/v1/features/feature-alpha/disable' );
		$response = $this->server->dispatch( $request );
	...
	public function test_disable_invalid_slug_returns_error(): void {
		...
		$request  = new WP_REST_Request( 'POST', '/liquidweb/harbor/v1/features/nonexistent/disable' );
		$response = $this->server->dispatch( $request );
	...
	public function test_update_returns_success_for_admin(): void {
		...
		$request  = new WP_REST_Request( 'POST', '/liquidweb/harbor/v1/features/feature-alpha/update' );
		$response = $this->server->dispatch( $request );
	...
	public function test_update_invalid_slug_returns_error(): void {
		...
		$request  = new WP_REST_Request( 'POST', '/liquidweb/harbor/v1/features/nonexistent/update' );
		$response = $this->server->dispatch( $request );
	...
	public function test_enable_disable_round_trip_updates_is_enabled(): void {
		...
		$get = new WP_REST_Request( 'GET', '/liquidweb/harbor/v1/features/feature-alpha' );
		...
		// Enable.
		$enable   = new WP_REST_Request( 'POST', '/liquidweb/harbor/v1/features/feature-alpha/enable' );
		...
		// Disable.
		$disable  = new WP_REST_Request( 'POST', '/liquidweb/harbor/v1/features/feature-alpha/disable' );
	...
	public function test_schema_plugin_variant_has_all_properties(): void {
		...
		$expected = [ 'slug', 'name', 'description', 'product', 'tier', 'type', 'is_available', 'in_catalog_tier', 'documentation_url', 'is_enabled', 'plugin_file', 'release_date', 'version', 'changelog', 'authors', 'wporg_slug', 'installed_version', 'update_version' ];
	...
	public function test_schema_theme_variant_has_installable_properties(): void {
		...
		$expected = [ 'slug', 'name', 'description', 'product', 'tier', 'type', 'is_available', 'in_catalog_tier', 'documentation_url', 'is_enabled', 'release_date', 'version', 'changelog', 'authors', 'wporg_slug', 'installed_version', 'update_version' ];
