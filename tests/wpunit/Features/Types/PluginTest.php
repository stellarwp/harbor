...
final class PluginTest extends HarborTestCase {
	...
	/**
	 * Tests a Plugin feature can be hydrated from an associative array.
	 *
	 * @return void
	 */
	...
	/**
	 * Tests that the type is always "plugin" regardless of constructor arguments.
	 *
	 * @return void
	 */
